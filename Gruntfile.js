...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            livereload: {
                ...
                files: ['<%= yeoman.app %>/{,*/}*.html', '.tmp/styles/{,*/}*.css', '<%= yeoman.app %>/images/{,*/}*.{gif,jpeg,jpg,png,svg,webp}']
            }
        },
        ...
        jasmine: {
            all: {
                src: ['<%= yeoman.app %>/scripts/main.js', '<%= yeoman.app %>/scripts/{,*/}*.js'],
                options: {
                    keepRunner: true,
                    specs: 'test/spec/{,*/}*.js'
                }
        ...
        //Casper an Pahntomjs screenshots for quick validating
        casper: {
            options: {
                // test : true,
    ...
    grunt.registerTask('test', function(target) {
        ...
        grunt.task.run(['connect:test', 'jasmine', 'casper:screentests:--url=www.triptyk.eu' //on passe ici l'url qu'on souaite tester
        ]);
    });
